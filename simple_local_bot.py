"""
Simple Local Bot - No Railway Conflicts
This bot runs only locally with your exact updated prize messages
"""
...
class SimpleLocalBot:
    ...
    def handle_real_prize_reveal(self, chat_id, message_id, user_id):
        ...
        real_prize_text = (
            ...
            "Remember the very first time when we started talking, I said I wanted to take up the challenge to get to know you as a person? 🙈\n"
            "I genuinely meant it.\n\n"
            "I know I joke around sometimes and send random things (and maybe confused you a bit too… or accidentally gave mixed signals along the way). But what if I told you… I genuinely want to pursue you in a gently, patiently, and with the kind of intention that actually means something?\n\n"
            "Also, let me guess... since ur a Capricorn, u must be an INTJ or INFJ, right?\n"
            "Correct me if I'm wrong... but either way, it's big trouble for me isn't it? HAHAHA\n\n"
            "23 years old shiok but also sibei tough hor?\n"
            "Coreen once said she still doesn't know what she wants to do after graduating...\n"
            "So i believe u r feeling damn lost w life, like wtf am i supposed to do now??, perhaps even comparing urself with others, whether you have this or that isnt it?.. Its normal HAHA\n\n"
            "Let me think... what was I doing at 23? Hmmmm I wonder\n\n"
            "Also, seems like some1 once said she \"keeps things to herself\"\n"
            "sounds like a dangerous girl hmm\n\n"
            "So how about this.. let me help you out a bit.\n"
            "From now on, just ask me anything u want at anytime\n"
            "Deep, random, or even embarrassing questions\n"
            "I will answer honestly\n\n"
            "No pressure if you just want to keep silently judging me 😏\n"
            "That's what girls do best, isn't it? HAHA\n\n"
            "Oh ya, Matcha where got taste like grass... Matcha is the best! NOOB"
        )
